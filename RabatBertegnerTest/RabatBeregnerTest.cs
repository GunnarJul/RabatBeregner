...
namespace RabatBertegnerTest
{
    public class RabatBeregnerTest
    {
        ...
        public void Mange_varer_og_stor_ordrer_giver_stor_rabat()
        {
            ...
            double pris = beregner.GetPrisEfterRabat(1000, 1000);

            // Normalpris er 1000 x 1000 = 1000000
            // 5% rabat er 50000
            // Forventetpris efter rabat er 950000
            Assert.Equal(950000, pris);
